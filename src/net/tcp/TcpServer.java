...
/**
 * Represents an asynchronous tcp server.
 */
public class TcpServer
{
     ...
     * The listeners.
     */
    private List<IServerListener<TcpClient>> _listeners = new ArrayList<>();

    /**
     * The listener for all clients.
     */
    private IClientListener<TcpClient> _clientListener = new IClientListener<>()
    {
        @Override
    ...
    /**
     * Initialises a new instance of the TcpServer class using the specified port.
     *
     ...
     */
    public void AddListener(IServerListener<TcpClient> listener)
    {
