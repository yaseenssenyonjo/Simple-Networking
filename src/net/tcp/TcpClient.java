...
public class TcpClient
{
     ...
     * The listeners.
     */
    private List<IClientListener<TcpClient>> _listeners = new ArrayList<>();

    /**
     * Initialises a new instance of the TcpClient class.
     */
    public TcpClient()
    {
        try
    ...
    /**
     * Initialises a new instance of the TcpClient class using the specified socket.
     *
     ...
     */
    public void AddListener(IClientListener<TcpClient> listener)
    {
    ...
    private void Read()
    {
        ...
        {
            @Override
            public void completed(Integer numberOfBytesRead, TcpClient client)
            {
